...
@doptools/cli/0.0.0-dev.2 linux-x64 node-v14.15.5
$ dops --help [COMMAND]
USAGE
  $ dops COMMAND
...
...
_See code: [src/commands/index.ts](https://github.com/doptools/cli/blob/v0.0.0-dev.2/src/commands/index.ts)_
