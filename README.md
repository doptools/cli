...
@doptools/cli/0.0.1-dev.1 linux-x64 node-v14.15.5
$ dops --help [COMMAND]
USAGE
  $ dops COMMAND
...
...
_See code: [src/commands/hello.ts](https://github.com/doptools/cli/blob/v0.0.1-dev.1/src/commands/hello.ts)_
